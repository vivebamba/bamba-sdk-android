...
public class CustomerApi {
  ...
  * Cancel customer services
   ...
   * @return Subscription
  */
  public Subscription customerCustomerIdServicesSkuCancelPut (String customerId, String sku) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'customerId' is set
    if (customerId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'customerId' when calling customerCustomerIdServicesSkuCancelPut",
        new ApiException(400, "Missing the required parameter 'customerId' when calling customerCustomerIdServicesSkuCancelPut"));
    }
    // verify the required parameter 'sku' is set
    if (sku == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'sku' when calling customerCustomerIdServicesSkuCancelPut",
        new ApiException(400, "Missing the required parameter 'sku' when calling customerCustomerIdServicesSkuCancelPut"));
    }
  ...
  */
  public void customerCustomerIdServicesSkuCancelPut (String customerId, String sku, final Response.Listener<Subscription> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
