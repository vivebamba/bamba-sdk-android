...
public class CustomerApi {
  ...
  * Get all customer services
   ...
   * @return List<Object>
  */
  public List<Object> customerCustomerIdServicesGet (String customerId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param customerId Bamba customer unique identifier
  */
  public void customerCustomerIdServicesGet (String customerId, final Response.Listener<List<Object>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public CancellationResponse customerCustomerIdServicesServiceIdCancelPut (String customerId, String serviceId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'customerId' is set
    if (customerId == null) {
   ...
   * Cancel customer services
   * Cancel customer services
   * @param customerId The customer UUID assigned by Bamba   * @param serviceId The service UUID to cancel assigned by Bamba
  */
  public void customerCustomerIdServicesServiceIdCancelPut (String customerId, String serviceId, final Response.Listener<CancellationResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
