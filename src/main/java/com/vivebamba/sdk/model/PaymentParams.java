...
public class PaymentParams {
   ...
   **/
  @ApiModelProperty(required = true, value = "Media type key to make the payment, available options CREDIT_CARD, DEBIT_CARD, PHONE_NUMBER, EMAIL, CLABE, CACAO, CUSTOMER_NUMBER, ACCOUNT_NUMBER")
