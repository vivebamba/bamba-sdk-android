...
import com.vivebamba.sdk.auth.Authentication;
import com.vivebamba.sdk.auth.ApiKeyAuth;
import com.vivebamba.sdk.auth.HttpBasicAuth;
import com.vivebamba.sdk.request.GetRequest;
import com.vivebamba.sdk.request.PostRequest;
import com.vivebamba.sdk.request.PutRequest;
import com.vivebamba.sdk.request.DeleteRequest;
import com.vivebamba.sdk.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("OpenAPI-Generator/1.2.4/android");
